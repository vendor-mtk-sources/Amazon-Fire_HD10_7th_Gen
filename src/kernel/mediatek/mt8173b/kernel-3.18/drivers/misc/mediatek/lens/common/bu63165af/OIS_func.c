			...
			OIS_UBYTE filter, OIS_UBYTE range, const _FACT_ADJ *param)
{
	...
	OIS_UWORD u16_dat_SCENE_SPORT_1[4] = { 0x7FE0, 0 /*ANGLE_LIMIT */ , G_SENSE * 5, 0x0300, };
	/* szx_2014/12/24 ===> */
	OIS_UWORD u16_dat_SCENE_SPORT_2[4] = { 0x7F80, 0 /*ANGLE_LIMIT */ , G_SENSE * 5, 0x0000, };
	OIS_UWORD u16_dat_SCENE_SPORT_3[4] = { 0x7FF0, 0 /*ANGLE_LIMIT */ , G_SENSE * 5, 0x0300, };
	/* szx_2014/12/24 <=== */
