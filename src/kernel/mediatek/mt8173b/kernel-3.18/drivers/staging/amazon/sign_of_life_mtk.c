...
#include "../../misc/mediatek/include/mt-plat/mt8173/include/mach/mtk_rtc_hal.h"
#include "../../misc/mediatek/include/mt-plat/mt8173/include/mach/mt_rtc_hw.h"
...
#define RTC_NEW_SPARE3_THERMAL_SYSRST_SOC	              (1U << 14)
...
static int (mtk_read_thermal_shutdown_reason)(life_cycle_thermal_shutdown_reason *thermal_shutdown_reason)
{
	...
	else if (rtc_thermal_shutdown_reason & RTC_NEW_SPARE3_THERMAL_SYSRST_SOC)
		*thermal_shutdown_reason = THERMAL_SYSRST_SOC;
	else {
...
static int (mtk_write_thermal_shutdown_reason)(life_cycle_thermal_shutdown_reason thermal_shutdown_reason)
{
	...
	printk(KERN_NOTICE"%s:shutdown_reason 0x%0x\n", __func__, rtc_thermal_shutdown_reason);
	...
	else if (thermal_shutdown_reason == THERMAL_SYSRST_SOC)
		rtc_thermal_shutdown_reason = rtc_thermal_shutdown_reason | RTC_NEW_SPARE3_THERMAL_SYSRST_SOC;
...
static int (mtk_write_special_mode)(life_cycle_special_mode special_mode)
{
	...
	printk(KERN_NOTICE"%s: special_mode 0x%x\n", __func__, rtc_smode);
